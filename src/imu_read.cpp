...
const float coeffient = 3.1415926 / 180.0; // rad/°
            ...
            */
            ...
            if(buf[i] == 0xA5) /* user ID */
            {
                ...
                if(buf[i+23] == kItemAtdE)
                {
                    ...
                    geometry_msgs::Quaternion quat = tf::createQuaternionMsgFromRollPitchYaw(Eular[1] * coeffient, Eular[0] * coeffient, Eular[2] * coeffient);
